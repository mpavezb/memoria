...
\end{tikzpicture}
	...
	\caption{\small Rueda de las Emociones de Plutchik. Propone 8 emociones primarias de carácter bipolar y 3 niveles de intensidad. Cada emoción compleja se compone de sus 2 emociones primarias adyacentes.}
	\label{img:plutchik}
\end{figure}
