...
\todowrite{REFERENCIA AL PAPER ESCRITO: towards long term memory for social robots}
...
\subsection{Otros aspectos de la memoria robótica}\label{sec:otros_aspectos}

\todowrite{Sobre aspectos no abordados en el trabajo.. hay varios de interés.. sirve para agrandar bibliografía y para detallar el trabajo futuro. Tengo algunos anotados en los googledocs y en mendeley..}

\todowrite{Tema: Construcción de memoria a corto plazo}

\todowrite{Tema: Inferencia de Información}

\todowrite{Tema: Sueño y pistas sobre eventos}

\todowrite{Tema: Aspectos éticos de almacenar información}

\todowrite{Tema: Compartir memoria entre robots y migración de ésta.}

\todowrite{Tema: Uso de LTM para modificar diálogos del robot con la gente.}
