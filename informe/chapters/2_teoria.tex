...
\unsure[inline]{Creo que el marco teórico está muy abultado... tiene sentido separar en dos capítulos: Aspectos teóricos y componentes de software y hardware??}
...
% - 
% - 
\improvement[inline]{Poner referencias a todo esto. ... psicoanalisis ... ciencias cognitivas.}
% \cite{Deutsch2008} 
...
% - 
% - 
\improvement[inline]{Sobre approaches para crear memorias episódicas.}
%Han existido diversos intentos por crear memorias episódicas y semánticas. ... tal persona hizo tal cosa .... desde el 2000


\improvement[inline]{Sobre los diseños de consolidación utilizados en la literatura.. son pocos :(}
...
\begin{enumerate}[topsep=0pt]
	...
	\item Flexibilidad: (R3) La información almacenada es declarativa por naturaleza, y puede ser flexiblemente almacenada. Particularmente, puede interactuar con conocimiento semántico, incluso si este fue obtenido con posterioridad a la codificación del episodio.\todo[inline]{Está OK esta descripción?.. }
...
\begin{enumerate}[topsep=0pt]
	...
	\improvement[inline]{Reescribir este requisito.. La información variable no es requisito deseable, sino que obligatorio.. sólo la no intrusividad es deseable..}
...
\todo[inline]{subsubsubsection: Procesos de consolidación y deterioro}
...
\todo[inline]{citar a \cite{Pratama2014}}
...
\todo[inline]{subsubsubsection: Manejo de la información en URF}
