...
\ltmconcept{Bender}
El año 2015 Sanchez et al.~\cite{Sanchez:2015} diseñaron un sistema de memoria episódica para el robot Bender (plataforma de este trabajo). Este primer acercamiento es descrito en detalle en la Sección~\ref{sec:primer_acercamiento} y es utilizado como parte de la motivación para este trabajo.
...
\subsubsection{Aspectos fuera del alcance del trabajo}\label{sec:otros_aspectos}
%% =====================================================================
...
El almacenamiento, deterioro y recolección de episodios puede ser afectado por diversos factores. A continuación se detallan estudios que influencian el diseño, en cuanto a la modulación de tales procesos cognitivos, a partir de la memoria emocional y la relevancia histórica de los episodios. En otras palabras, los estudios que aquí se exponen son la base para el cálculo de las relevancias episódicas de la memoria LTM.
...
\end{table}
\todoNOPE{jocelyn: Sobre cita en Tabla \ref{img:emotional_haikonen}. es raro que algo propuesto por persona X salga de un paper por persona Y .. cual es la referencia original al modelo de Haikonen?}
...
\todoNOPE{jocelyn: falta una frase para conectar este párrafo con lo presentado anteriormente}
...
\todoNOPE{jocelyn: no es posible integrar las secciones 2.4.2.1 y 2.4.2.2? dado que sigues hablando del trabajo de Dood ..}
