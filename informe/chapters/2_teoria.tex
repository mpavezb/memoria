...
\todoimprove{Falta título de subsubsubsection: Procesos de consolidación y deterioro}
...
.
\todowrite{Agregar diagramas funcionamiento ROS??}
...
\todoimprove{Falta título de subsubsubsection: Manejo de la información en URF}
