...
\todojavier{Sería bueno un ejemplo}
...
\todojavier{timestamps o tiempo humano??? o 18 sept 2018 o primer semestre.. cómo se realiza la traducción.}
...
%% =============================================================================
%% =============================================================================
\todojavier{no debería haber una jerarquía?? lab..univ..santgo...}
...
\todojavier{Es necesario si se toman episodios de base a relevancia??}
...
\todojavier{sólo de sit f. local o de internet?? ej. país??}
