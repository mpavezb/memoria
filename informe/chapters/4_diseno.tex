...
El documento consta de alrededor de 35 validaciones, cada una indicada por un prefijo y numeración de la forma \Vlabel{T}{XX} (V: Validación, T: Tipo, XX: numeración). Cada validación indica su requisito de sistema asociado. Se definen 5 categorías: 
\begin{enumerate}
...
\todojocelyn{Describir los otros 3 grupos de validaciones. Dejar para más adelante, cuando sean separadas correctamente en categorías clásicas: funcionalidad, foo, bar.}
