...
\todowrite{Formalizar metadatos de requisitos de sistema, usuario, validaciones.}
...
\todowrite{AGREGAR DIAGRAMA GENERAL DEL SISTEMA... DB -- LTM -- PLUGINS -- USER}
\todowrite{AGREGAR DIAGRAMA DE COMPONENTES y comunicación}
...
\todowrite{Agregar diagrama explicando anidamiento, transposición.}
