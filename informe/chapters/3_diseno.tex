...
\todo[inline]{Modificar implementación, para soportar más de 1 lugar semántico y coordenado para hijos.}
...
\unsure[inline]{Todo todo todo debe estar en 3ra persona singular presente??? como hablo de decisiones pasadas??... según esto, corregir todos los párrafos.}
...
\todo[inline]{Crear submensaje para Where.msg, que almacene: location, area, time}
\todo[inline]{Limitante: En un futuro se podría agregar un 3er nivel de información, para almacenar info ultra específica, por ejemplo: ``al lado de la tele'', ``cerca del refrigerador''..}
...
\todo[inline]{Modificar implementación para agregar soporte a más de un frame/mapa.}
\todo[inline]{Crear submensaje para Where.msg, que represente ubicación coordenada múltiple}
...
\change[inline]{Actualizar estos datos de acuerdo a la modificación que se hará al sistema.}
\begin{itemize}
...
\todo[inline]{Escribir más cuando esté implementado}
...
\item TODO
\end{itemize}
\todo[inline]{Agregar representación de relevancia generalizada, una vez que sea implementada.}
...
\todo[inline]{Actualizar esto en caso de modificar metadatos}
...
\todo[inline]{Sobre la tasa de decaimiento histórica implementada.}
...
% REQUISITOS
\paragraph{Requisitos:}
% - what puede contener cualquier dato

% GENERALIZANDO MEMORIA SEMÁNTICA
\paragraph{Generalización:}
% - no imponer datos para campo WHAT-
% - usuario debe poder elegir contenidos
% - contenidos ligados al campo
...
% CAMPOS QUE SOPORTAN A LOS PLUGINS
\paragraph{Estrategia de almacenamiento}


% SOBRE STREAMS
\paragraph{Datos semánticos - Streams:}
% - streams son tipos de datos no variables.. no es necesario actualizarlos, pues almacenan la versión real y final de la información
% - streams sirven para demostraciones..
% - streams y relación con memoria semántica... son realmente memoria semántica??
...
\todo[inline]{Reescribir tras tener primera implementación razonable}
...
% SOBRE UBICACIÓN
\todo[inline]{Depende de reimplementación del sistema de ubicación}
%       - ubicación 2D
%       - ubicación y frames
...
% SOBRE CONTEXTO ??
\todo[inline]{Depende de si quito la definición de contexto como padres de nodos.}
%       - contexto: introducción manual? TO DO

% SOBRE COMPLETITUD Y LAPSOS EN BLANCO..
%       - todo dato que es calculado a partir de hijos puede estar incompleto,
%         debido a que pueden haber lapsos de tiempo en blanco.
%          - ubicaciones
%          - relevancias
%          - what
%       - Finalmente, todo depende del usuario y que episodios está dispuesto a almacenar.
