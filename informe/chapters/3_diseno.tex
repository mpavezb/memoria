...
\todo[inline]{Episodio almacena tags para describir entidades y cambios?.}
...
\todo[inline]{IMP: LTM server con warning en texto y notificación inotify cuando quede poco espacio de disco (menor a X\%) (o se ha ocupado más de X GB) debido al server... configurable por usuario...}
...
\todo[inline]{IMP: Manejo de perspectiva y audit al requerir insertar episodio al medio (temporalmente) de otros ya existentes.}

\todo[inline]{Escribir tras tener primera implementación razonable}
...
\end{itemize}
\todo[inline]{Corregir campos con los de la versión final.}
...
\todo[inline]{IMP: COMO MANEJAR CONTEXTOS, PUES SE PUEDE REQUERIR SU INFORMACIÓN, INCLUSO DURANTE EL MISMO EPISODIO!!.. DEBEN SER ALMACENADOS UNA VEZ INSCRITOS Y SER CERRADOS MANUALMENTE.}
