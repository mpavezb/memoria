...
\todojocelyn{Explicar que son las bases de datos no relacionales.}
...
URF está construido sobre ROS y utiliza una estructura de 4 capas, cómo se presenta en la Figura~\ref{img:URF}:
\begin{enumerate}
\item De acuerdo al diagrama, la capa inferior contiene todas las dependencias del sistema, ya sean de ROS o no. Es la única capa que contiene sólo código externo.
