...
\todowrite{TERMINAR ESTO... QUITAR SECCION GRANDE..}
...
\item La última capa de alto nivel es desarrollada en Python, con interfaces para el uso de las capacidades de menor nivel, y es utilizada para la elaboración de maquinas de estado y comportamientos robóticos complejos mediante SMACH (cuadros \textit{Interfaz ROS-python} y \textit{Máquinas de Estado} del diagrama).
\end{enumerate}
