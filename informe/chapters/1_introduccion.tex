...
\begin{itemize}
	...
	\item El diseño no se ajusta a los requerimientos mínimos para un sistema episódico, como los propuestos por Stachowicz~\cite{Stachowicz2012}, particularmente no cumple con los requisitos \RStachowicz{1}, \RStachowicz{9}, \RStachowicz{10} ni \RStachowicz{11}. Los requerimientos de Stachowicz son extensos y se describen en detalle en la Sección \ref{sec:ltm_exp}.
