...
\todoimprove{INTRO: Corrección de referencias y cosas obsoletas.}
...
\todounsure{Es necesario hablar de la robocup??}
...
Más adelante se detallan cada uno de los aspectos anteriores. En el Capítulo \ref{chapter:theory} se hace una revisión de cada punto, respecto al estado del arte. Mientras que en el Capítulo \ref{chapter:metodologia} se propone una alternativa de solución a cada uno de ellos.
...
% - 
% - 
\todowrite{Sobre la estructura de la memoria}