...
\item Asistencia a ancianos y discapacitados: Sillas rob\'oticas, de asistencia.
\item Transporte.
...
El foco de \'este trabajo son los robots de servicio personales, enfocados en tareas dom\'esticas, clasificaci\'on a la que en  adelante se referir\'a como \textit{Robots Dom\'esticos}.

Un robot dom\'estico de compa\~nia y asistencia tiene, pero no se limita a las siguientes tareas:
\begin{itemize}[topsep=0pt]
\setlength\itemsep{0.2em}
\item Interacci\'on amistosa con humanos.
\item Ayudar a recordar y organizar tareas.
\item Cooperar a con la realizaci\'on de un procedimiento.
\end{itemize}
\bigskip
...
Si un robot implementa URF, entonces es posible acceder a la informaci\'on compartida por sus procesos. Cualquier m\'odulo ROS en el sistema tiene acceso a los datos extraídos desde sensores y luego generados en postprocesamientos, junto al acceso para controlar el hardware.
