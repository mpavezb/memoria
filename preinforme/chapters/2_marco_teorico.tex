...
\todo[inline]{Escribir introducci\'on al cap\'itulo!}
...
\todo[inline]{Sobre los requerimientos en espec\'ifico para robots dom\'esticos}
...
\todo[inline]{Sobre approaches para crear memorias epis\'odicas.}
%Han existido diversos intentos por crear memorias epis\'odicas y sem\'anticas. ... tal persona hizo tal cosa ....


\todo[inline]{Sobre los dise\~nos de consolidaci\'on utilizados en la literatura.. son pocos :(}
...
\todo[inline]{Sobre los implementaciones de procesos de consolidaci\'on y deterioro}
...
\todo[inline]{Sobre otros enfoques no biol\'ogicos para LTM}
...
\todo[inline]{Sobre librer\'ia para m\'aquinas de estado (a utilizar en la demostraci\'on)}
...
\todo[inline]{Sobre concepto de robot skills y c\'omo permiten acceder a componentes del robot. Ser\'an utilizadas para la demo.}
...
\todo[inline]{M\'as info sobre knowRob... todo el trabajo se basar\'a en este software!.}
...
%\subsection{Pepper}
%
%Pepper es un robot humanoide desarrollado por SoftBank Robotics, orientado a la interacci\'on humano robot y con el objetivo de ser un robot de compa\~n\'ia y soporte emocional.
