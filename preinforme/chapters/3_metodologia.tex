...
\todo[inline]{Sobre como ser\'a la rutina de desmostraci\'on a implementar.}
...
\begin{gantt}{10}{9}
    ...
    \ganttbar[color=red]{Dise\~no}{1}{1}
    \ganttbar[color=magenta]{Implementaci\'on}{2}{2}
    \ganttbar[color=yellow]{Integraci\'on}{4}{1}
	\ganttbar[color=red]{Demostraci\'on}{5}{1}
